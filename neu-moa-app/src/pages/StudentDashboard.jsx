...
export default function StudentDashboard() {
  ...
  const renderStudentBadge = () => (
    <span style={{ display: 'inline-block', background: '#e6f4ea', color: '#1e8e3e', border: '1px solid #cce8d6', padding: '4px 14px', borderRadius: '20px', fontSize: '0.75rem', fontWeight: '600', textAlign: 'center', whiteSpace: 'normal', wordBreak: 'break-word', maxWidth: '100%' }}>
      Approved
    </span>
  )
          ...
          <div className="dashboard-card" style={{ padding: '24px', marginBottom: '32px' }}>
            ...
            <div className="responsive-flex" style={{ display: 'flex', gap: '12px', marginBottom: showFilters ? '20px' : '0' }}>
              <div style={{ flex: 1, position: 'relative' }}>
                <input type="text" className="search-bar" placeholder="Search by company name, contact person, or address..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} style={{ width: '100%', maxWidth: '100%', padding: '12px 12px 12px 44px', background: '#fff', border: '1px solid #eaeaea', borderRadius: '8px', boxSizing: 'border-box' }}/>
